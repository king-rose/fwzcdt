package com.agree.activiti.modeler;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (com.agree.common.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (com.agree.common.utils.StringUtils.isNotBlank(modelEntity.getName())) {
