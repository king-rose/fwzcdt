...
import com.agree.activiti.service.IProcessDefinitionService;
import com.agree.common.core.page.PageDomain;
import com.agree.common.core.page.TableSupport;
import com.agree.common.core.text.Convert;
...
public class ProcessDefinitionService implements IProcessDefinitionService {
     ...
     */
    @Override
    public Page<com.agree.activiti.domain.ProcessDefinition> listProcessDefinition(com.agree.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.agree.activiti.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            ...
            com.agree.activiti.domain.ProcessDefinition entity = new com.agree.activiti.domain.ProcessDefinition();
