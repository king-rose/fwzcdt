		...
		<div>
			<div class="setting-drawer-content">
				...
				<div class="setting-drawer-block-checbox">
					...
					<div class="setting-drawer-block-checbox-item" @click="handleTheme('theme-yellow')">
						<img alt="yellow" src="@/assets/images/yellow.svg">
						<div v-if="sideTheme === 'theme-yellow'" class="setting-drawer-block-checbox-selectIcon"
							 style="display: block;">
							<i aria-label="图标: check" class="anticon anticon-check">
								<svg :fill="theme" aria-hidden="true" class="" data-icon="check" focusable="false"
									 height="1em"
